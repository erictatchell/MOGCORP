export const STRINGS = {
  ...
  profile: {
    ...
    helper: "Authored uploads grouped by trip and folder.",
    ...
    routeInvalid: "ROUTE ID MUST BE 3 CHARACTERS OF A-Z OR 0-9.",
    loading: "Loading profile...",
    empty: "No authored posts yet.",
  ...
  errors: {
    ...
    itemCertificationFailed: "Could not update certification.",
